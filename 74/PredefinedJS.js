...
var val11_5 = val11_1.lastIndexOf("is",20); // 20 karakter içerisindeki son "is" nerde onun indis sayısını bul
document.write("<br/> <br/>");
...
//12-Search
var valSearch1 = "Joseph HenimeX github adress is : https://github.com/henimex";
var valSearch2 = valSearch1.search("github");
var valSearch3 = valSearch1.search(/Github/i); //ignores case sensitive
document.write("<br/> <br/>");
document.write("Search" + "<br/> <br/>");
document.write("----------------------" + "<br/> <br/>");
document.write("Var 1 : " + valSearch1 + "<br/>"); 
document.write("Var 2 : " + valSearch2 + "<br/>");
document.write("Var 3 : " + valSearch3 + "<br/>");

//13-Includes

//Search degerinin bool donus vereni

var valIncludes1 = valSearch1.includes("github");
document.write("<br/> <br/>");
document.write("Includes" + "<br/> <br/>");
document.write("----------------------" + "<br/> <br/>");
document.write("Var 1 : " + valIncludes1 + "<br/>"); 
document.write("Var 1 : " + valIncludes1 + "<br/>"); 